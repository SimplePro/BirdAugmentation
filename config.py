...
background_img_path_list = [os.path.join("Landscape", filename) for filename in os.listdir("Landscape")]

# class_imgid_list
with open("CUB200\image_class_labels.txt", "r") as f:
...
# class_name_list
with open("CUB200\classes.txt", "r") as f:
    for line in f.readlines():
...
# imgid_bbox_dict
with open(os.path.join("CUB200", "bounding_boxes.txt"), "r") as f:
    for line in f.readlines():
